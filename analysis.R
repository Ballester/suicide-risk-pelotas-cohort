...
original_matrix = original_matrix[complete.cases(matrix),]
...
model <- train(RS_incidencia~., data=train_matrix,
                     trControl=train_control, method="xgbTree", weights=weights, tuneGrid=xgbGrid)

prefix = paste("/home/spc/Projects/suicide_pelotas/data/stats_", SEED, ".txt", sep="")
sink(prefix)
print("===CORRELATIONS===")
...
prepare_risk$rec = original_matrix_test$rec

write.csv(prepare_risk, file=paste("/home/spc/Projects/suicide_pelotas/data/predictions_", SEED, ".csv", sep=""))
...
#write.csv(importance, file="/home/spc/Projects/suicide_pelotas/data/importance.csv")
